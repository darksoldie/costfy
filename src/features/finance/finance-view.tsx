...
import { useFinanceQueries } from "./finance.queries";
import { useFinanceMutations } from "./finance.actions";
...
export function FinanceView() {
  ...
  const { createFixedCost, createEntry } = useFinanceMutations(
    workspaceId,
    active?.workspace.base_currency || "BRL",
  );
